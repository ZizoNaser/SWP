...
public class SWEProject {
    ...
    public static void SignUpS( String fn , String ln , String un , String pw  , int a , String sc   ){
    ...
    public static void SignIn(String un , String pw){
        boolean found =  false;
        for(int i=0;i<db.users.size();i++){
            if(db.users.get(i).username.equals(un)){
    ...
    public static void save(){
        ...
        try {
            out=new PrintWriter(new File("/home/zizo/NetBeansProjects/SWE Project/data"));
   ...
   public static void load(){
       Scanner scan=null; 
       try {
            scan=new Scanner(new File("/home/zizo/NetBeansProjects/SWE Project/data"));
        } catch (FileNotFoundException ex) {
            Logger.getLogger(SWEProject.class.getName()).log(Level.SEVERE, null, ex);
        }
       if(scan.hasNext()){
